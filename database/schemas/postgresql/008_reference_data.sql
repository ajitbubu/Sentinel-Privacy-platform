-- Reference data: purposes and channels.
--
-- These live in the schema sequence rather than a separate seeds step because
-- the application renders an empty preference centre without them — they are
-- structural, not sample data. Idempotent, so re-running is safe.
